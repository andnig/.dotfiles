      ...
      <div className="right">
        {output.cpu && (
            <button className={`cpu ${getCpuUsageRate(output.cpu)}`}
              onClick={() =>{
                output.glazewm.runCommand('shell-exec %windir%\\system32\\taskmgr.exe /7');
              }}>
              ...
              <div className="template mem-content">
                ...
                <div className="labels">
                  <span className="label total">
                    <span>USED</span>
                    { Math.round(output.memory.usedMemory / 1024 / 1024 / 1024) }GB
                  </span>
                  <span className="label total">
                    <span>TOT</span>
                    { Math.round(output.memory.totalMemory / 1024 / 1024 / 1024) }GB
                  </span>
                </div>
